...
struct bitmap_table{
    ...
    struct bitmap_table *link;
};

struct bitmap_table * bitmap_head;
...
/*Addditional Implementation*/
struct bitmap_table* bitmap_find(char*);
struct bitmap *bitmap_expand(struct bitmap *, int);
void bitmap_dumpdata(struct bitmap* );
void bitmap_command(char *);
